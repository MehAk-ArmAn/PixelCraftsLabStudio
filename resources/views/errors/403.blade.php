...
@section('body')Your account is signed in, but this page sits behind a permission it does not hold. If that looks wrong, ask whoever manages access.@endsection
