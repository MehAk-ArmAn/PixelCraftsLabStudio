...
class SiteSettingsSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        return [
            ...
            ['home_intro_beats', 'Idea,Design,Build,Launch,Grow', 'home', 'string', 'Intro beats', 'Comma-separated words shown during the intro sequence.'],
            ['home_intro_scroll_label', 'scroll to enter', 'home', 'string', 'Scroll hint', null],
            ...
            ['pricing_remaining_label', 'places remaining', 'pricing', 'string', 'Availability suffix', null],
            ['pricing_original_price_label', 'Previously', 'pricing', 'string', 'Original price label', null],
